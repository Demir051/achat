...
const s = (size = 20, style?: CSSProperties) => ({ width: size, height: size, style });

export const HashIcon = ({ size, className, style }: IconProps) => (
  <svg {...s(size, style)} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const MicOffIcon = ({ size, className }: IconProps) => (
  <svg {...s(size)} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ScreenIcon = ({ size, className }: IconProps) => (
  <svg {...s(size)} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="2" y="3" width="20" height="14" rx="2" ry="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" />
  </svg>
);

export const PhoneOffIcon = ({ size, className }: IconProps) => (
  <svg {...s(size)} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const MessageIcon = ({ size, className }: IconProps) => (
  <svg {...s(size)} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
